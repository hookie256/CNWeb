...
namespace PharmacyWebAPIinMVC.Models.DAO
{
    ...
    {
        public EFModels.THUOC SanPham { get; set; }
    ...
    public class Cart
    {
        ...
        public void themSP(EFModels.THUOC sp, int sl)
        {
        ...
        public void capnhatSP(EFModels.THUOC sp, int sl)
        {
            CartItem dongSP = gioHang
                .Where(p => p.SanPham.MaThuoc == sp.MaThuoc)
                .FirstOrDefault();
        ...
        public void XoaSP(EFModels.THUOC sp)
        {
            gioHang.RemoveAll(l => l.SanPham.MaThuoc == sp.MaThuoc);
        }
