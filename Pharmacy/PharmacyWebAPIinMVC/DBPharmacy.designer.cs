...
namespace PharmacyWebAPIinMVC
{
    ...
    partial void DeleteTHUOC(THUOC instance);
		...
		public DBPharmacyDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CNWeb_PharmacyConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class GIAOHANG : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private char _HinhThucGiaoHang;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnHinhThucGiaoHangChanging(char value);
    ...
    partial void OnTenHinhThucChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HinhThucGiaoHang", DbType="NChar(1) NOT NULL", IsPrimaryKey=true)]
		public char HinhThucGiaoHang
		{
			get
			{
    ...
    partial void OnTienKMChanging(int value);
