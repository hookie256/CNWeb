...
using PharmacyWebAPIinMVC.Models.DAO;
...
namespace PharmacyWebAPIinMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult DanhMuc(string id, int? page)
        {
            ...
            foreach (PharmacyWebAPIinMVC.Models.EFModels.THUOC it in item)
            {
        ...
        public ActionResult Cart()
        {
            ...
            if (dem == 0)
            {
                if (Request.Cookies["login"] != null)
                {
                    ...
                    {
                        gioHang = new Cart();
                        foreach (PharmacyWebAPIinMVC.Models.EFModels.GIOHANG it in items)
                        {
        ...
        public ActionResult ThemSP(string id, string soluong)
        {
            ...
            if (item.Count() == 0)
            {
                Models.EFModels.GIOHANG g = new Models.EFModels.GIOHANG();
        ...
        [HttpPost]
        public ActionResult ThanhToan(Models.EFModels.HOADON model, string ho, string ten, string diachiduong, string sonha, string email, string sdt, string ghichu, string makhuyenmai, string giaohang)
        {            
            ...
            {
                Models.EFModels.CHITIETHOADON obj = new Models.EFModels.CHITIETHOADON();
        ...
        {
            Models.EFModels.KHACHHANG kh = new Models.EFModels.KHACHHANG();
        ...
        public ActionResult LoginControl(string email, string password, string duytri)
        {
            ...
            if (user.Count() != 0)
            {
                foreach (PharmacyWebAPIinMVC.Models.EFModels.KHACHHANG us in user)
                {
                    var userSession = new UserLogin();
